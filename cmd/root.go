...
import (
	...
	"github.com/iscas-fork/k0s/cmd/airgap"
	"github.com/iscas-fork/k0s/cmd/api"
	"github.com/iscas-fork/k0s/cmd/backup"
	...
	"github.com/iscas-fork/k0s/cmd/reset"
	"github.com/iscas-fork/k0s/cmd/restore"
	"github.com/iscas-fork/k0s/cmd/start"
	"github.com/iscas-fork/k0s/cmd/status"
	"github.com/iscas-fork/k0s/cmd/stop"
	"github.com/iscas-fork/k0s/cmd/sysinfo"
	"github.com/iscas-fork/k0s/cmd/token"
	"github.com/iscas-fork/k0s/cmd/validate"
	"github.com/iscas-fork/k0s/cmd/version"
	"github.com/iscas-fork/k0s/cmd/worker"
