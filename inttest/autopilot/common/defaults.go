...
var Versions = K0sVersionedPlatformResourceMap{
	"v1.24.4+k0s.0": {
		"linux-amd64": {
			"k0s": {
				"url":    "https://github.com/iscas-fork/k0s/releases/download/v1.24.4+k0s.0/k0s-v1.24.4+k0s.0-amd64",
				"sha256": "c94fb7da760cbdde5ef90e0183cf9c2dd32be139d82e64c3f6ab83d614049383",
			},
			"airgap": {
				"url":    "https://github.com/iscas-fork/k0s/releases/download/v1.24.4+k0s.0/k0s-airgap-bundle-v1.24.4+k0s.0-amd64",
				"sha256": "7a3e5ccee558f0935ec39b416513a90fa504d1fdf720a17565a2e50d401b9935",
			},
		},
		"linux-arm64": {
			"k0s": {
				"url":    "https://github.com/iscas-fork/k0s/releases/download/v1.24.4+k0s.0/k0s-v1.24.4+k0s.0-arm64",
				"sha256": "e0037114f1a36f10c2bf5bba672adb3a29b0aae16f22180317630c03d05ee8d0",
			},
			"airgap": {
				"url":    "https://github.com/iscas-fork/k0s/releases/download/v1.24.4+k0s.0/k0s-airgap-bundle-v1.24.4+k0s.0-arm64",
				"sha256": "4980e00a4124ca39842b227c45645ae4c777e62e78be0837b32c798d5192405a",
			},
		},
		"windows-amd64": {
			"k0s": {
				"url":    "https://github.com/iscas-fork/k0s/releases/download/v1.24.4+k0s.0/k0s-v1.24.4+k0s.0-amd64.exe",
