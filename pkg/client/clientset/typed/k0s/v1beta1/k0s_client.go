...
import (
	...
	"github.com/iscas-fork/k0s/pkg/client/clientset/scheme"
...
// NewForConfigAndClient creates a new K0sV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*K0sV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
