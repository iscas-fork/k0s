...
import (
	...
	applan "github.com/iscas-fork/k0s/pkg/autopilot/controller/plans"
	aproot "github.com/iscas-fork/k0s/pkg/autopilot/controller/root"
	apsig "github.com/iscas-fork/k0s/pkg/autopilot/controller/signal"
	apupdate "github.com/iscas-fork/k0s/pkg/autopilot/controller/updates"
